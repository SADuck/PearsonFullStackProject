...
const ContactUs = (props) => {
  return (
    <div className="contact-us-container">
      <Helmet>
        <title>Contact-Us - Dern-Support</title>
        <meta property="og:title" content="Dern-Support" />
      </Helmet>
      <header data-role="Header" className="contact-us-header">
        <div className="contact-us-nav"></div>
        <h1 className="contact-us-text"><Link to="/HomeClient">Dern-Support</Link></h1>
      </header>
      <div className="contact-us-container1">
        <h1 className="contact-us-text01">
          <span>Contact Us</span>
          <br></br>
        </h1>
        <div className="contact-us-container2">
          <h1 className="contact-us-text04">Contact Form</h1>
          <div className="contact-us-container3">
            <label className="contact-us-text05">Name</label>
            <input
              type="text"
              placeholder="Name"
              className="contact-us-textinput input"
            />
            <label className="contact-us-text06">E-mail</label>
            <input
              type="text"
              placeholder="E-mail"
              className="contact-us-textinput1 input"
            />
            <label className="contact-us-text07">Phone</label>
            <input
              type="text"
              placeholder="Phone"
              className="contact-us-textinput2 input"
            />
            <label className="contact-us-text08">Message</label>
            <textarea
              placeholder="Message"
            ...
            <div className="contact-us-container4">
              ...
              <span className="contact-us-text09">Upload File</span>
      ...
      <footer className="contact-us-footer">
        <h1 className="contact-us-text10">Dern-Support</h1>
