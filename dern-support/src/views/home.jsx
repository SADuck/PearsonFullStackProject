  ...
  return (
    <div className="home-container">
      ...
      <header data-role="Accordion" className="home-header">
        <span className="home-text"><Link to="/HomeNewUser">Dern-Support</Link></span>
          ...
          <div className="home-container01">
            ...
            <div className="home-container02">
              ...
              <button type="button" className="home-button1 button">
                <span>
                  <span className="home-text02"><Link to={"/signup"}>Sign Up</Link></span>
                  <br></br>
                </span>
              </button>
            </div>
      ...
      <div className="home-hero">
        <h1 className="home-text04">
          <span className="home-text05">Let&apos;s Repair them!</span>
          <br></br>
        </h1>
        ...
        <div className="home-btn-group">
          <button className="home-button2 button">Sign up</button>
          <button className="home-button3 button">Learn More</button>
        </div>
      </div>
      <div className="home-features">
        <h1 className="home-text15">All these impressive features</h1>
      ...
      <div className="home-stats">
        <div className="home-stat">
          ...
          <span className="home-text23">Happy clients</span>
        ...
        <div className="home-stat1">
          ...
          <span className="home-text27">PCs Repaired</span>
        ...
        <div className="home-stat2">
          ...
          <span className="home-text32">Parts Replaced</span>
        ...
        <div className="home-stat3">
          ...
          <span className="home-text36">Support</span>
        ...
        <div className="home-container06">
          ...
          <div className="home-step1">
            ...
            <div className="home-container12">
              <h1 className="home-text41">Submit Support Request</h1>
            </div>
          </div>
          <div className="home-step2">
            ...
            <div className="home-container15">
              <h1 className="home-text42">Drop Your PC By</h1>
            </div>
          </div>
          <div className="home-step3">
            ...
            <div className="home-container18">
              <h1 className="home-text43">Happy PC!</h1>
            </div>
          </div>
        </div>
      </div>
      <footer className="home-footer">
        <h1 className="home-text44">Dern-Support</h1>
