...
import './home-employee.css'

const HomeEmployee = (props) => {
  return (
    <div className="home-employee-container">
      <Helmet>
        <title>Home-Employee - Dern-Support</title>
        <meta property="og:title" content="Dern-Support" />
      </Helmet>
      <header data-role="Accordion" className="home-employee-header">
        <span className="home-employee-text"><Link to="/HomeEmployee">Dern-Support</Link></span>
        <div className="home-employee-separator"></div>
        <nav className="home-employee-nav">
          <div className="home-employee-container01">
            <NavigationLinks
              button1="Data Analysis"
              button2="Spare Parts Inventory"
              button21="Job Scheduler"
              link1='/Inventory'
              link2='/schuldeJob'
              link3='/analysisPage'
              rootClassName="rootClassName8"
            ></NavigationLinks>
            <div className="home-employee-container02">
        ...
        <div
          ...
          className="home-employee-accordion-header"
        >
          <svg viewBox="0 0 1024 1024" className="home-employee-icon">
            <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
          </svg>
        </div>
        <div
          data-role="AccordionContent"
          className="home-employee-accordion-content"
        >
          <div className="home-employee-nav1">
            <NavigationLinks rootClassName="rootClassName9"></NavigationLinks>
          </div>
        </div>
        <div className="home-employee-separator1"></div>
      </header>
      <div className="home-employee-hero">
        <h1 className="home-employee-text04">
          <span className="home-employee-text05">Hey Employee!</span>
          <br></br>
        </h1>
        <span className="home-employee-text07">
        ...
        <div className="home-employee-btn-group">
          <Link className="home-employee-button2 button" type="button" to={"/Inventory"}>
            Go to the Inventory
          </Link>
          <Link className="home-employee-button3 button" type="button" to={"/schuldeJob"}>Schedule Jobs</Link>
        </div>
      </div>
      <div className="home-employee-features">
        <h1 className="home-employee-text15">All these impressive features</h1>
        <div className="home-employee-container03">
          <Features
            title="Fast Repair"
      ...
      <div className="home-employee-testimonial">
        <div className="home-employee-container04">
          <h1 className="home-employee-text16">
            <span>What they’re saying</span>
            <br></br>
            <span></span>
          </h1>
          <span className="home-employee-text19">
            Explore testimonials from our satisfied clients and learn more about
            the quality of our services!
          </span>
          <div className="home-employee-container05">
            <Reviews
              name="Jane Does"
              role="Designer"
      ...
      <div className="home-employee-stats">
        <div className="home-employee-stat">
          <h1 className="home-employee-text20">
            <span>50</span>
            <span>+</span>
          </h1>
          <span className="home-employee-text23">Happy clients</span>
          <span className="home-employee-text24">
        ...
        <div className="home-employee-stat1">
          <h1 className="home-employee-text25">
            <span>369</span>
          </h1>
          <span className="home-employee-text27">PCs Repaired</span>
          <span className="home-employee-text28">
            Over 360 PCs successfully serviced!
          </span>
        </div>
        <div className="home-employee-stat2">
          <h1 className="home-employee-text29">
            <span>500</span>
            <span>+</span>
          </h1>
          <span className="home-employee-text32">Parts Replaced</span>
          <span className="home-employee-text33">
            Over 500 PC parts replaced at competitive prices!
          </span>
        </div>
        <div className="home-employee-stat3">
          <h1 className="home-employee-text34">
            <span>24/7</span>
          </h1>
          <span className="home-employee-text36">Support</span>
          <span className="home-employee-text37">
            Available 24/7 for inquiries and support!
          </span>
        </div>
      </div>
      <div className="home-employee-steps">
        <h1 className="home-employee-text38">
          <span>Discover Our Process</span>
        </h1>
        <div className="home-employee-container06">
          <div className="home-employee-step">
            <div className="home-employee-container07">
              <div className="home-employee-line"></div>
              <div className="home-employee-container08">
                <svg viewBox="0 0 1024 1024" className="home-employee-icon02">
              ...
              <div className="home-employee-line1"></div>
            </div>
            <div className="home-employee-container09">
              <h1 className="home-employee-text40">Get In Touch</h1>
            </div>
          </div>
          <div className="home-employee-step1">
            <div className="home-employee-container10">
              <div className="home-employee-line2"></div>
              <div className="home-employee-container11">
                <svg viewBox="0 0 1024 1024" className="home-employee-icon04">
              ...
              <div className="home-employee-line3"></div>
            </div>
            <div className="home-employee-container12">
              <h1 className="home-employee-text41">Submit Support Request</h1>
            </div>
          </div>
          <div className="home-employee-step2">
            <div className="home-employee-container13">
              <div className="home-employee-line4"></div>
              <div className="home-employee-container14">
                <svg viewBox="0 0 1024 1024" className="home-employee-icon06">
              ...
              <div className="home-employee-line5"></div>
            </div>
            <div className="home-employee-container15">
              <h1 className="home-employee-text42">Drop Your PC By</h1>
            </div>
          </div>
          <div className="home-employee-step3">
            <div className="home-employee-container16">
              <div className="home-employee-line6"></div>
              <div className="home-employee-container17">
                <svg viewBox="0 0 1024 1024" className="home-employee-icon08">
              ...
              <div className="home-employee-line7"></div>
            </div>
            <div className="home-employee-container18">
              <h1 className="home-employee-text43">Happy PC!</h1>
            </div>
          </div>
        </div>
      </div>
      <footer className="home-employee-footer">
        <h1 className="home-employee-text44">Dern-Support</h1>
        <span className="home-employee-text45">
          © 2024 Dern-Support, All Rights Reserved.
        </span>
        <div className="home-employee-icon-group">
          <animate-on-reveal
            animation="swing"
            duration="300ms"
            delay="0s"
          ...
          >
            <svg
              ...
              className="home-employee-icon10"
            >
          ...
          >
            <svg
              ...
              data-thq-animate-on-reveal="true"
              className="home-employee-icon12"
            >
          ...
          >
            <svg
              ...
              data-thq-animate-on-reveal="true"
              className="home-employee-icon14"
            >
